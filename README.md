...
>
> If you already use Home Assistant, it’s strongly recommended to use an automation with the Google Nest integration instead. Three example automations are included in this repository.
>
